...
function redondearNumero(num) {
  ...
  var ok = num % 1
  var resto = num - ok
  if (ok >= 0.5) {return resto + 1;} else {return resto}
}
...
function redondearHaciaArriba(num) {
  ...
  var ok = num % 1
  var resto = num - ok
  if (ok>0) {return resto + 1;} else {return resto}
}
...
function esVocal(letra){
  ...
  //Escribe tu código aquí
  if (letra.lenght > 1) {return "Dato incorrecto";} else  if(letra === "a" || letra === "e" || letra === "i" || letra === "o" || letra === "u"){
    return "Es vocal";
  } else
